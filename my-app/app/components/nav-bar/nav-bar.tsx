...
export default function NavBar({
  ...
  if (windowWidth < 860)
    // If you're changing this, remember to change --breakpoint-desktop in globals.css too
    return <MobileNavBar links={links} />;

  if (variant === 1) {
    return (
      <nav
        role="navigation"
        className={`${showOnScroll ? (showNav ? "top-0" : "-top-24") : "top-0"} fixed z-50 w-full transition-all`}
      >
