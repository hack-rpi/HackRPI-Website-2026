		...
		<div className="dropdown dropdown-hover">
			...
			<ul
				...
				className="
					...
					bg-linear-to-r from-white/60 from-50% to-sky-200/60
...
export default function DesktopNavBarVariant({ links }: { links: NavGroup[] }) {
  return (
    ...
    <div className="w-full h-16 bg-linear-to-r from-sky-200/60 via-white/60 to-sky-200/60 text-slate-800 backdrop-blur-sm">
      <div
