...
export default function Team() {
  ...
  return (
    <div
      className="relative min-h-0 overflow-hidden bg-gBlack pt-12 pb-4 md:min-h-screen md:py-20"
      id="pin"
    >
      <div className="relative z-10 mb-16 flex max-w-4xl flex-col gap-4 px-6 md:px-16">
        <h2
          id="team-title"
          className="relative text-left font-mono text-2xl font-bold tracking-wider text-white/90 uppercase"
        ...
        <p className="text-lg leading-relaxed text-white/70">
          Hello! We are a motivated team of RPI students who share a passion for exploring the
          bounds of Computer Science and a commitment to organizing a fantastic event. Our team of
          students from every grade and major work together to organize our annual fall hackathon as
          well as other smaller events throughout the year. We are always looking for more students
          to join our team and help us make our event a success. If you are interested in helping,
      ...
      <div
        ...
        className="relative z-10 flex w-full snap-x gap-0 overflow-x-auto overflow-y-visible scroll-smooth px-6 pb-4 select-none md:px-16 md:pb-12"
      >
        {teamMembers.map((member, i) => (
          <div
            key={member.name}
            className={`relative shrink-0 snap-start ${i !== 0 ? "-ml-6 md:ml-0" : ""}`}
