  ...
  return (
    <div className="h-[250vh] will-change-transform translate-z-0 bg-white" id="mentions-container">
      <div className="flex h-[140vh] gap-0 bg-gBlack">
        <div
          className="flex-1 h-[90vh] bg-gray-600 items-center justify-center text-4xl text-center flex"
          id="trophy-canvas"
        ...
        <div className="flex-1 h-screen w-full text-center content-center grid gap-5 bg-gBlack" id="mentions">
          <span
            className="text-4xl font-mono relative w-fit mx-auto"
            id="mentions-animate"
          ...
          {Array.from({ length: 10 }).map((_, i) => (
            <span
              key={i}
              className="text-xl font-mono relative w-fit mx-auto"
              id="mentions-animate"
              style={{ clipPath: "inset(0px 100% 0px 0px)" }}
            >
              John Doe
      ...
      <div
        className="w-full h-[10vh] bg-gBlack"
