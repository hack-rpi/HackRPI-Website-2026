...
export default function HackRPILink({
  ...
  return (
    <NextLink
      href={href}
      className={` ${className} group font-pix relative border-2 border-purple-500 text-3xl font-medium text-sky-500 transition-all duration-500 hover:bg-purple-500 hover:text-yellow-500`}
      target={target}
    >
      {children}
      <svg
        className="absolute top-1 right-1 fill-purple-500 transition-colors duration-0 group-hover:fill-yellow-500"
