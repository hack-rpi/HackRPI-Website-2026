...
function Model() {
	...
	return (
		<primitive object={scene} position={[0, -1, 0]} scale={2.2} />
	);
}
	...
	return (
		<div className="relative w-full h-screen bg-gray-600 p-5 overflow-hidden">
			...
			<div className="relative z-10 w-fit h-[50vh] p-0 flex flex-col pt-30 pl-20">
				<div className="text-blue-200 text-4xl leading-none ml-3" style={{ fontFamily: "Calibri, sans-serif" }}>November 7, 8th • Troy, NY</div>
				<div className="text-[14rem] font-bold leading-none tracking-tight" style={{ fontFamily: "Calibri, sans-serif" }}>HackRPI</div>
