...
export default function AboutUs() {
  useGSAP(() => {
    ...
    gsap.timeline().to("#letter", { x: 2, y: -20, duration: 1 }).yoyo(true).repeat(-1);
  });
    ...
    <div className="relative p-5 bg-sky-500 h-screen">
      <div
        ...
        className="
			...
			"
      >
        <h2 className="p-7 pb-3 text-yellow-400 text-4xl">About HackRPI</h2>
        <div className="p-7 pb-3 pt-0 text-black text-sm">
          ...
          for students. Starting at noon on Saturday, November 7th, teams of 1-4 people have 24 hours to build and
          submit projects relating to our theme, <b className="text-blue-600">In the Clouds</b>. After submitting their
      ...
      <div className="absolute left-[26%] top-[25%]">
        <Image src={envelope} alt="Envelope" width={750} />
      </div>
      ...
      <dialog id="about-us-letter" className="modal">
        <div className="modal-box bg-white rounded-none w-[65vh]">
          ...
          <div className="p-7 pb-3 pt-0 text-black text-sm">
            HackRPI 2026 is Rensselaer Polytechnic Institute's 13th annual intercollegiate hackathon hosted by students
            for students. Starting at noon on Saturday, November 7th, teams of 1-4 people have 24 hours to build and
            submit projects relating to our theme, <b className="text-blue-500">In the Clouds</b>. After submitting
            their projects, participants demonstrate their projects in front of a panel of professors, industry
