...
const Page: React.FC = () => {
  ...
  const regularArticles = articles.filter((article) => !article.featured && article.category !== "Hackathon");
  ...
  return (
    <div className="main-container">
      ...
      <section className="featured-grid">
        <Article data={featuredArticle} variant="featured" onClick={() => handleArticleClick(featuredArticle)} />
      </section>
            ...
            <div className="horizontal-scroll-container">
              {hackathonArticles.map((article) => (
                <div key={article.id} className="horizontal-scroll-card">
                  <Article data={article} variant="card" onClick={() => handleArticleClick(article)} />
                </div>
              ))}
            </div>
          </section>
