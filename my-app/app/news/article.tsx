...
const Article: React.FC<ArticleProps> = ({ data, variant = "card", onClick }) => {
  ...
  if (variant === "card") {
    return (
      <article className="article-card fade-in-up shine-effect" onClick={onClick} style={{ cursor: "pointer" }}>
  ...
  if (variant === "featured") {
    return (
      <article className="featured-article fade-in-up" onClick={onClick} style={{ cursor: "pointer" }}>
        <img src={imageUrl} alt={title} className="article-image" />
  ...
  return (
    <article className="article-page">
      ...
      <div className="article-hero">
        <img ref={heroRef} src={imageUrl} alt={title} className="article-hero-image" />
