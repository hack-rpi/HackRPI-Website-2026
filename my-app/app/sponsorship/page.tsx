    ...
    <>
      ...
      <div style={{ minHeight: "calc(100vh - 16px)", width: "100%" }}>
        ...
        <div className="container bg-sky-500">
          <div className="p-5 text-center neumorphic">Click the buttons to see the benefits!</div>
        </div>
        <div id="container1" className="container bg-sky-500">
          <div
            className="clickable neumorphic sponsorCard centerText"
            onClick={function () {
        ...
        <div className="container bg-sky-500">
          <div id="container3" className="clickable neumorphic container centerText" style={{}}>
            <div className="stackText text-lg" style={{}}>
              ...
              <h4>
                Please contact &nbsp;
                <a href="mailto:hackrpi@rpi.edu">hackrpi@rpi.edu</a>&nbsp; if you want to develop a tailored sponsorship
                package.
              </h4>
            </div>
          </div>
        ...
        <div className="container bg-sky-500">
          <div id="container4" className="neumorphic container" style={{}}>
            <div id="docText" className="stackText" style={{}}>
              ...
              <p>
                Participants usually attend to take breaks from their work, perfect time to learn about your company and
                any job openings
              </p>
              ...
              <p>
                Your company will be featured on the mail we send out to all hackers signed up before the main event
              </p>
