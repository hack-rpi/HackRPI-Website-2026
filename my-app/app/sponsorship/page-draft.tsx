...
export const metadata: Metadata = {
  ...
  description: "This is the sponsorship page for HackRPI 2026. Please consider doing so!",
};
  ...
  return (
    <>
      ...
      <main className="flex flex-col w-full">
        <div className="w-full h-[9vh] p-5 text-center">Sponsor us!</div>
        ...
        <div className="w-full h-auto bg-sky-500 text-black p-5 text-center flex justify-center">
          <div className="w-[90vh] bg-white p-5 m-10">
            ...
            <h2>
              Please contact{" "}
              <a href="mailto:hackrpi@rpi.edu" className="text-blue-500 ">
                hackrpi@rpi.edu
              </a>{" "}
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border-2 border-blue-500 p-5">
                  ...
                  <p>
                    Opportunity to send a company representative to serve as a judge for the main hackathon event
                    (in-person).
                  </p>
                </td>
              </tr>
              <tr>
                <td className="border-2 border-blue-500 p-5">
                  <h3>Resume Book</h3>
                  <p>
                    Your company will be included on the list we send out participant resumes to (after the event in
                    mid-November).
                  </p>
                  <p>
                    In Gold tier or above, your company will be included on the list we send out participant resumes to
                    (before the event in early September).
                  </p>
                </td>
                <td className="border-2 border-blue-500 p-5">
                  ...
                  <p>
                    Participants usually attend to take breaks from their work, perfect time to learn about your company
                    and any job openings.
                  </p>
                </td>
              </tr>
              <tr>
                <td className="border-2 border-blue-500 p-5">
                  ...
                  <p>
                    Opportunity to host a workshop relating to one or more of your company's products for any interested
                ...
                <td className="border-2 border-blue-500 p-5">
                  ...
                  <p>
                    Your company will be featured on the mail we send out to all hackers signed up before the main
                    event.
                  </p>
                </td>
              </tr>
              <tr>
                <td className="border-2 border-blue-500 p-5">
                  ...
                  <p>
                    Your booth/table will be closer to the entrance and area where the majority of participants are.
                  </p>
                </td>
                <td className="border-2 border-blue-500 p-5">
                  <h3>Opening Ceremony Demo</h3>
                  <p>
                    During our opening ceremony, we'll have a short slot for you to feature your company/product as a
                    sponsor of HackRPI.
                  </p>
                </td>
              </tr>
              <tr>
                <td className="border-2 border-blue-500 p-5">
                  ...
                  <p>
                    We provide a table but will accomodate if you want to bring a custom booth/multiple table setup.
                  </p>
                </td>
                <td className="border-2 border-blue-500 p-5"></td>
              </tr>
            </tbody>
          </table>
        </div>
