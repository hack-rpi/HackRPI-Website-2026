...
const faqs: FAQ[] = [
  ...
  // },
  {
    ...
    content:
      "Bring your team, your laptop, chargers, any hardware you need, and a good night's sleep!",
  },
  {
    title: "Does HackRPI provide travel reimbursement?",
    content: (
      <p>
        Unfortunately, we are unable to provide travel reimbursement at this time, however, we have
        sleep rooms on campus for students 18 and older, and we are more than happy to recommend
        local accommodations if you email us at{" "}
  ...
  },
  {
    ...
    content: (
      <p>
        Yes! You can arrive at any time during the event, but we recommend arriving before 11 AM on
        Saturday.
        <br />
  ...
  {
    title: "When are submissions due? How do I submit my project?",
    content: (
      <p>
        All projects must be submitted to Devpost by 10 AM on Sunday.
        <br />
        You will be able to modify your submission until 11am. After 11 AM, no coding or changes to
        your project are allowed.
        <br />
        You will submit your project on Devpost. See our &quot;Event Information&quot; and
