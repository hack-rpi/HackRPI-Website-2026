...
const faqs: FAQ[] = [
  {
    ...
    content: (
      <p>
        HackRPI takes place on __month__ _day_ and __day+1__, 2026, in the Darrin Communication Center at Rensselaer
        Polytechnic Institute.
        <br />
        Arrival and check-in takes place from 9-10 AM. Our opening ceremony starts at 10 AM, and hacking begins at 11am.
        <br />
        During hacking time, teams of 1-4 have 24 hours to build a project relating to our theme, In the Clouds. Teams
        will then present their projects, and the best projects win prizes!
        <br />
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        <br />
        Whether you are a hackathon veteran or this is your first hackathon, this is a great opportunity to learn,
        experiment with new technologies, and grow your skills.
        <br />
        Our team of experienced mentors is here to help you in every step of the way.
        <br />
  ...
  },
  {
    ...
    content: (
      <p>
        No! HackRPI is open to everyone, students of all experience levels from all colleges and universities are
        welcome to attend.
        <br />
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        <br />
        You will be able to modify your submission until 11am. After 11an, no coding or changes to your project are
        allowed.
      </p>
    ),
  },
