...
export const metadata: Metadata = {
  ...
  description: "Event information for HackRPI 2026",
};
      ...
      <main className="flex flex-col w-full">
        <div className="w-full h-auto bg-gradient-to-b from-purple-300 to-24% to-sky-500 flex flex-row text-white pt-10">
          ...
          <div className="w-[45%] p-5">
            ...
            Mentors will be available throughout HackRPI to provide invaluable guidance and assistance to participants.
            Whether you need help with coding, debugging, refining your project idea, or navigating the challenges of a
            hackathon, our experienced mentors are here to support you every step of the way. With their expertise,
            you'll be able to overcome obstacles, learn new skills, and maximize your hackathon experience. Don't
            hesitate to seek out their advice and make the most of the mentorship opportunities available at HackRPI.
          </div>
          <div className="w-[45%] p-5">
            <h2>Event Discord</h2>
            Join the HackRPI 2025 Discord server to stay connected and make the most of your hackathon experience! Have
            questions for the staff? Want to chat with other participants? Looking for a team? Join the conversation on
            Discord and get the support you need to succeed at HackRPI.
            <HackRPILink
        ...
        <div className="w-full h-auto bg-gradient-to-b from-sky-500 to-[#00ff7f] text-white p-5 flex flex-col">
          ...
          <div className="w-full border-2 border-orange-500 p-[1em]">SUBMISSION INFO</div>
        </div>
      </main>
